...
(function () {
  ...
  var I18N = {
    en: {
      ...
      "cyber.index": "05 — CYBERSECURITY",
      "cyber.title": "We don't just defend. <span class=\"gradient-text\">We hunt the threat.</span>",
      "cyber.lead": "Offensive security, secure code review, and red teaming — we break what we build, before anyone else can.",
      "cyber.body": "Every system we ship is attacked before your adversaries ever get the chance. Madrigal's security practice thinks like the attacker and reports like the engineer: penetration tests, adversarial red-team operations, secure code and architecture reviews, and continuous vulnerability management — each delivered with a clear, prioritized, reproducible report your team can act on the same day. From a single web app to a regulated financial platform, we turn security from a checkbox into a decisive advantage.",
      "cyber.line": "We break it, so they can't.",
      "cyber.cta": "Test Your Defenses",
      "cy1.tag": "Offensive Security", "cy1.t": "Penetration Testing", "cy1.d": "External, internal, web, mobile, API and cloud penetration tests — deep, manual, and methodology-driven (OWASP, PTES, OSSTMM). Every finding ships with proof, business impact, and a step-by-step fix.",
      "cy2.tag": "Actionable Reporting", "cy2.t": "Pentest Reports", "cy2.d": "Clear, prioritized, reproducible reports — an executive summary for the board, technical depth for the engineers, CVSS scoring, and a remediation roadmap you can ship against immediately.",
      "cy3.tag": "Secure SDLC", "cy3.t": "Code & Architecture Review", "cy3.d": "Manual secure code review backed by SAST/DAST and threat modeling — we read the code line by line, map the attack surface, and design the weakness out before release.",
      "cy4.tag": "Adversarial Simulation", "cy4.t": "Red Teaming", "cy4.d": "Full-scope adversary emulation — assumed-breach, social engineering and physical vectors — to prove how your people, processes and detection actually hold up under a real attack.",
      "cy5.tag": "Continuous Assurance", "cy5.t": "Vulnerability Management", "cy5.d": "Continuous scanning, expert triage and remediation tracking — so new exposures are found, prioritized and closed long before they can become an incident.",
      "cy6.tag": "GRC", "cy6.t": "Audit & Compliance", "cy6.d": "ISO 27001, SOC 2, GDPR and PCI-DSS readiness — gap analysis, hardening and audit-ready evidence, engineered to satisfy the strictest regulators on the planet.",
      "footer.p6": "Cybersecurity",

      "work.index": "06 — THE MADRIGAL DIFFERENCE",
    ...
    it: {
      ...
      "cyber.index": "05 — CYBERSECURITY",
      "cyber.title": "Non ci limitiamo a difendere. <span class=\"gradient-text\">Cacciamo la minaccia.</span>",
      "cyber.lead": "Sicurezza offensiva, code review e red teaming — rompiamo ciò che costruiamo, prima che possa farlo qualcun altro.",
      "cyber.body": "Ogni sistema che rilasciamo viene attaccato prima che i tuoi avversari ne abbiano la possibilità. La practice di sicurezza di Madrigal pensa come l'attaccante e documenta come l'ingegnere: penetration test, operazioni red-team avversariali, revisione sicura di codice e architettura, e gestione continua delle vulnerabilità — ognuna consegnata con un report chiaro, prioritizzato e riproducibile su cui il tuo team può agire lo stesso giorno. Da una singola web app a una piattaforma finanziaria regolamentata, trasformiamo la sicurezza da casella da spuntare in vantaggio decisivo.",
      "cyber.line": "Lo rompiamo noi, così non possono farlo loro.",
      "cyber.cta": "Metti alla prova le tue difese",
      "cy1.tag": "Sicurezza Offensiva", "cy1.t": "Penetration Testing", "cy1.d": "Penetration test external, internal, web, mobile, API e cloud — approfonditi, manuali e guidati dalla metodologia (OWASP, PTES, OSSTMM). Ogni finding arriva con prova, impatto sul business e correzione passo-passo.",
      "cy2.tag": "Reportistica Operativa", "cy2.t": "Report di Pentest", "cy2.d": "Report chiari, prioritizzati e riproducibili — sintesi executive per il board, profondità tecnica per gli ingegneri, scoring CVSS e una roadmap di remediation subito operativa.",
      "cy3.tag": "SDLC Sicuro", "cy3.t": "Code & Architecture Review", "cy3.d": "Code review manuale supportata da SAST/DAST e threat modeling — leggiamo il codice riga per riga, mappiamo la superficie d'attacco e progettiamo via la debolezza prima del rilascio.",
      "cy4.tag": "Simulazione Avversariale", "cy4.t": "Red Teaming", "cy4.d": "Emulazione dell'avversario a tutto campo — assumed-breach, social engineering e vettori fisici — per dimostrare come persone, processi e detection reggono davvero sotto un attacco reale.",
      "cy5.tag": "Assurance Continua", "cy5.t": "Vulnerability Management", "cy5.d": "Scansione continua, triage esperto e tracciamento della remediation — così le nuove esposizioni vengono trovate, prioritizzate e chiuse molto prima di diventare un incidente.",
      "cy6.tag": "GRC", "cy6.t": "Audit & Compliance", "cy6.d": "Readiness ISO 27001, SOC 2, GDPR e PCI-DSS — gap analysis, hardening ed evidenze audit-ready, ingegnerizzate per soddisfare i regolatori più severi del pianeta.",
      "footer.p6": "Cybersecurity",

      "work.index": "06 — LA DIFFERENZA MADRIGAL",
      ...
      "process.index": "07 — COME LAVORIAMO",
      ...
      "global.index": "08 — PRESENZA GLOBALE",
